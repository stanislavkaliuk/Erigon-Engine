...
using namespace ImGui::NodeEditor::Internal;
using namespace ImGui::NodeEditor;
...
{
    if ((flags & DrawFlags::Hovered) != DrawFlags::None)
    {
...
{
    if (flags == Internal::Object::DrawFlags::None)
    {
...
# endif
    ...
    else if ((flags & DrawFlags::Selected) != DrawFlags::None)
    {
    ...
    else if (!IsGroup(this) && ((flags & DrawFlags::Hovered) != DrawFlags::None))
    {
...
void Link::Draw(ImDrawList* drawList, DrawFlags flags)
{
    ...
    else if ((flags & DrawFlags::Hovered) != DrawFlags::None)
    {
...
//
//------------------------------------------------------------------------------
ImGui::NodeEditor::Internal::EditorContext::EditorContext(const ImGui::NodeEditor::Config* config)
    : m_IsFirstFrame(true)
...
ImGui::NodeEditor::Internal::EditorContext::~EditorContext()
{
    if (m_IsInitialized)
        SaveSettings();
...
void ImGui::NodeEditor::Internal::EditorContext::Begin(const char* id, const ImVec2& size)
{
    if (!m_IsInitialized)
    {
        LoadSettings();
...
void ImGui::NodeEditor::Internal::EditorContext::End()
{
    //auto& io          = ImGui::GetIO();
    ...
    // Highlight selected objects
    {
        ...
        for (auto selectedObject : *selectedObjects)
            if (selectedObject->IsVisible())
                selectedObject->Draw(drawList, Object::DrawFlags::Selected);
    }
    ...
    if (!isSelecting)
    {
        ...
        if (hoveredObject && !IsSelected(hoveredObject) && hoveredObject->IsVisible())
            hoveredObject->Draw(drawList, Object::DrawFlags::Hovered);
    }
...
bool ImGui::NodeEditor::Internal::EditorContext::DoLink(LinkId id, PinId startPinId, PinId endPinId, ImU32 color, float thickness)
{
    //auto& editorStyle = GetStyle();
...
void ImGui::NodeEditor::Internal::EditorContext::SetNodePosition(NodeId nodeId, const ImVec2& position)
{
    ...
    if (node->m_Bounds.Min != position)
    {
        ...
        node->m_Bounds.Floor();
        MakeDirty(ImGui::NodeEditor::SaveReasonFlags::Position, node);
    }
}

ImVec2 ImGui::NodeEditor::Internal::EditorContext::GetNodePosition(NodeId nodeId)
{
    auto node = FindNode(nodeId);
    if (!node)
...
ImVec2 ImGui::NodeEditor::Internal::EditorContext::GetNodeSize(NodeId nodeId)
{
    auto node = FindNode(nodeId);
    if (!node)
        return ImVec2(0, 0);
...
void ImGui::NodeEditor::Internal::EditorContext::MarkNodeToRestoreState(Node* node)
{
    node->m_RestoreState = true;
}

void ImGui::NodeEditor::Internal::EditorContext::RestoreNodeState(Node* node)
{
...
void ImGui::NodeEditor::Internal::EditorContext::ClearSelection()
{
    m_SelectedObjects.clear();
}

void ImGui::NodeEditor::Internal::EditorContext::SelectObject(Object* object)
{
    m_SelectedObjects.push_back(object);
}

void ImGui::NodeEditor::Internal::EditorContext::DeselectObject(Object* object)
{
...
void ImGui::NodeEditor::Internal::EditorContext::SetSelectedObject(Object* object)
{
    ClearSelection();
    SelectObject(object);
}

void ImGui::NodeEditor::Internal::EditorContext::ToggleObjectSelection(Object* object)
{
...
bool ImGui::NodeEditor::Internal::EditorContext::IsSelected(Object* object)
{
    return std::find(m_SelectedObjects.begin(), m_SelectedObjects.end(), object) != m_SelectedObjects.end();
}

const vector<Object*>& ImGui::NodeEditor::Internal::EditorContext::GetSelectedObjects()
{
    return m_SelectedObjects;
}

bool ImGui::NodeEditor::Internal::EditorContext::IsAnyNodeSelected()
{
...
bool ImGui::NodeEditor::Internal::EditorContext::IsAnyLinkSelected()
{
    for (auto object : m_SelectedObjects)
        if (object->AsLink())
            return true;
...
bool ImGui::NodeEditor::Internal::EditorContext::HasSelectionChanged()
{
    return m_LastSelectedObjects != m_SelectedObjects;
}

Node* ImGui::NodeEditor::Internal::EditorContext::FindNodeAt(const ImVec2& p)
{
    for (auto node : m_Nodes)
        if (node->TestHit(p))
            return node;
...
void ImGui::NodeEditor::Internal::EditorContext::FindNodesInRect(const ImRect& r, vector<Node*>& result, bool append, bool includeIntersecting)
{
    if (!append)
        result.resize(0);
...
void ImGui::NodeEditor::Internal::EditorContext::FindLinksInRect(const ImRect& r, vector<Link*>& result, bool append)
{
    if (!append)
        result.resize(0);
...
void ImGui::NodeEditor::Internal::EditorContext::FindLinksForNode(NodeId nodeId, vector<Link*>& result, bool add)
{
    if (!add)
        result.clear();
...
bool ImGui::NodeEditor::Internal::EditorContext::PinHadAnyLinks(PinId pinId)
{
...
void ImGui::NodeEditor::Internal::EditorContext::NotifyLinkDeleted(Link* link)
{
    if (m_LastActiveLink == link)
        m_LastActiveLink = nullptr;
}

void ImGui::NodeEditor::Internal::EditorContext::Suspend(SuspendFlags flags)
{
    auto drawList = ImGui::GetWindowDrawList();
...
void ImGui::NodeEditor::Internal::EditorContext::Resume(SuspendFlags flags)
{
    auto drawList = ImGui::GetWindowDrawList();
    if ((flags & SuspendFlags::KeepSplitter) != SuspendFlags::KeepSplitter)
        ImDrawList_SwapSplitter(drawList, m_Splitter);
...
bool ImGui::NodeEditor::Internal::EditorContext::IsSuspended()
{
    return m_Canvas.IsSuspended();
}

bool ImGui::NodeEditor::Internal::EditorContext::IsActive()
{
    return m_IsWindowActive;
}

Pin* ImGui::NodeEditor::Internal::EditorContext::CreatePin(PinId id, PinKind kind)
{
...
Node* ImGui::NodeEditor::Internal::EditorContext::CreateNode(NodeId id)
{
    IM_ASSERT(nullptr == FindObject(id));
...
ImGui::NodeEditor::Internal::Link* ImGui::NodeEditor::Internal::EditorContext::CreateLink(LinkId id)
{
    IM_ASSERT(nullptr == FindObject(id));
...
Node* ImGui::NodeEditor::Internal::EditorContext::FindNode(NodeId id)
{
    return FindItemInLinear(m_Nodes, id);
}

Pin* ImGui::NodeEditor::Internal::EditorContext::FindPin(PinId id)
{
    return FindItemIn(m_Pins, id);
}

ImGui::NodeEditor::Internal::Link* ImGui::NodeEditor::Internal::EditorContext::FindLink(LinkId id)
{
    return FindItemIn(m_Links, id);
}

Object* ImGui::NodeEditor::Internal::EditorContext::FindObject(ObjectId id)
{
    if (id.IsNodeId())
...
Node* ImGui::NodeEditor::Internal::EditorContext::GetNode(NodeId id)
{
...
Pin* ImGui::NodeEditor::Internal::EditorContext::GetPin(PinId id, PinKind kind)
{
...
ImGui::NodeEditor::Internal::Link* ImGui::NodeEditor::Internal::EditorContext::GetLink(LinkId id)
{
...
void ImGui::NodeEditor::Internal::EditorContext::LoadSettings()
{
...
void ImGui::NodeEditor::Internal::EditorContext::SaveSettings()
{
    m_Config.BeginSave();
...
void ImGui::NodeEditor::Internal::EditorContext::MakeDirty(ImGui::NodeEditor::SaveReasonFlags reason)
{
    m_Settings.MakeDirty(reason);
}

void ImGui::NodeEditor::Internal::EditorContext::MakeDirty(ImGui::NodeEditor::SaveReasonFlags reason, Node* node)
{
    m_Settings.MakeDirty(reason, node);
}

ImGui::NodeEditor::Internal::Link* ImGui::NodeEditor::Internal::EditorContext::FindLinkAt(const ImVec2& p)
{
    for (auto& link : m_Links)
...
ImU32 ImGui::NodeEditor::Internal::EditorContext::GetColor(ImGui::NodeEditor::StyleColor colorIndex) const
{
    return ImColor(m_Style.Colors[colorIndex]);
}

ImU32 ImGui::NodeEditor::Internal::EditorContext::GetColor(ImGui::NodeEditor::StyleColor colorIndex, float alpha) const
{
    auto color = m_Style.Colors[colorIndex];
    return ImColor(color.x, color.y, color.z, color.w * alpha);
}

void ImGui::NodeEditor::Internal::EditorContext::RegisterAnimation(Animation* animation)
{
    m_LiveAnimations.push_back(animation);
}

void ImGui::NodeEditor::Internal::EditorContext::UnregisterAnimation(Animation* animation)
{
...
void ImGui::NodeEditor::Internal::EditorContext::UpdateAnimations()
{
...
void ImGui::NodeEditor::Internal::EditorContext::Flow(Link* link)
{
    m_FlowAnimationController.Flow(link);
}

void ImGui::NodeEditor::Internal::EditorContext::SetUserContext(bool globalSpace)
{
...
void ImGui::NodeEditor::Internal::EditorContext::EnableShortcuts(bool enable)
{
    m_ShortcutsEnabled = enable;
}

bool ImGui::NodeEditor::Internal::EditorContext::AreShortcutsEnabled()
{
    return m_ShortcutsEnabled;
}

Control ImGui::NodeEditor::Internal::EditorContext::BuildControl(bool allowOffscreen)
{
...
void ImGui::NodeEditor::Internal::EditorContext::ShowMetrics(const Control& control)
{
    auto& io = ImGui::GetIO();
...
//
//------------------------------------------------------------------------------
Animation::Animation(ImGui::NodeEditor::Internal::EditorContext* editor) :
    Editor(editor),
    m_State(Stopped),
    m_Time(0.0f),
    m_Duration(0.0f)
...
//
//------------------------------------------------------------------------------
NavigateAnimation::NavigateAnimation(ImGui::NodeEditor::Internal::EditorContext* editor, NavigateAction& scrollAction) :
    Animation(editor),
    Action(scrollAction)
{
}
...
{
    ImRect current;
    current.Min = Easing::EaseOutQuad(m_Start.Min, m_Target.Min - m_Start.Min, progress);
    current.Max = Easing::EaseOutQuad(m_Start.Max, m_Target.Max - m_Start.Max, progress);
...
void FlowAnimation::Flow(ImGui::NodeEditor::Internal::Link* link, float markerDistance, float speed, float duration)
{
    Stop();
...
//
//------------------------------------------------------------------------------
FlowAnimationController::FlowAnimationController(ImGui::NodeEditor::Internal::EditorContext* editor) :
...
void FlowAnimationController::Flow(ImGui::NodeEditor::Internal::Link* link)
{
...
FlowAnimation* FlowAnimationController::GetOrCreate(ImGui::NodeEditor::Internal::Link* link)
{
...
NavigateAction::NavigateAction(ImGui::NodeEditor::Internal::EditorContext* editor, ImGui::NodeEditor::Canvas& canvas) :
    EditorAction(editor),
    m_IsActive(false),
    m_Zoom(1),
    m_Scroll(0, 0),
...
EditorAction::AcceptResult NavigateAction::Accept(const Control& control)
{
...
bool NavigateAction::HandleZoom(const Control& control)
{
    ...
    auto targetRect = m_Canvas.CalcViewRect(CanvasView(-targetScroll, newZoom));
...
ImGui::NodeEditor::CanvasView NavigateAction::GetView() const
{
    return ImGui::NodeEditor::CanvasView(-m_Scroll, m_Zoom);
}
...
{
    auto view = m_Canvas.CalculateCenterView(rect);
...
//
//------------------------------------------------------------------------------
SizeAction::SizeAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_IsActive(false),
    m_Clean(false),
    m_SizedNode(nullptr),
...
EditorAction::AcceptResult SizeAction::Accept(const Control& control)
{
    IM_ASSERT(!m_IsActive);
...
//
//------------------------------------------------------------------------------
DragAction::DragAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_IsActive(false),
    m_Clear(false),
...
EditorAction::AcceptResult DragAction::Accept(const Control& control)
{
    IM_ASSERT(!m_IsActive);
...
//
//------------------------------------------------------------------------------
SelectAction::SelectAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_IsActive(false),
...
EditorAction::AcceptResult SelectAction::Accept(const Control& control)
{
    IM_ASSERT(!m_IsActive);
...
void SelectAction::Draw(ImDrawList* drawList)
{
    ...
    const auto alpha = m_Animation.IsPlaying() ? Easing::EaseOutQuad(1.0f, -1.0f, m_Animation.GetProgress()) : 1.0f;
...
//
//------------------------------------------------------------------------------
ContextMenuAction::ContextMenuAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
...
EditorAction::AcceptResult ContextMenuAction::Accept(const Control& control)
{
...
//
//------------------------------------------------------------------------------
ShortcutAction::ShortcutAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_IsActive(false),
    m_InAction(false),
...
EditorAction::AcceptResult ShortcutAction::Accept(const Control& control)
{
...
//
//------------------------------------------------------------------------------
CreateItemAction::CreateItemAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_InActive(false),
    m_NextStage(None),
    m_CurrentStage(None),
...
EditorAction::AcceptResult CreateItemAction::Accept(const Control& control)
{
    IM_ASSERT(!m_IsActive);
...
bool CreateItemAction::Process(const Control& control)
{
    ...
    if (m_DraggedPin && control.ActivePin == m_DraggedPin && (m_CurrentStage == Possible))
    {
        ...
        ImGui::NodeEditor::Internal::Link candidate(Editor, 0);
...
//
//------------------------------------------------------------------------------
DeleteItemsAction::DeleteItemsAction(ImGui::NodeEditor::Internal::EditorContext* editor) :
    EditorAction(editor),
    m_IsActive(false),
...
EditorAction::AcceptResult DeleteItemsAction::Accept(const Control& control)
{
    IM_ASSERT(!m_IsActive);
    ...
    {
        vector<ImGui::NodeEditor::Internal::Link*> links;
        for (auto object : m_CandidateObjects)
        {
            auto node = object->AsNode();
            if (!node)
...
//
//------------------------------------------------------------------------------
NodeBuilder::NodeBuilder(ImGui::NodeEditor::Internal::EditorContext* editor) :
    Editor(editor),
...
void NodeBuilder::BeginPin(PinId pinId, PinKind kind)
{
    IM_ASSERT(nullptr != m_CurrentNode);
...
//
//------------------------------------------------------------------------------
HintBuilder::HintBuilder(ImGui::NodeEditor::Internal::EditorContext* editor) :
    Editor(editor),
    m_IsActive(false),
    m_CurrentNode(nullptr)
{
...
//
//------------------------------------------------------------------------------
void InternalStyle::PushColor(StyleColor colorIndex, const ImVec4& color)
{
...
void InternalStyle::PopColor(int count)
{
    while (count > 0)
    {
...
void InternalStyle::PushVar(StyleVar varIndex, float value)
{
...
void InternalStyle::PushVar(StyleVar varIndex, const ImVec2& value)
{
...
void InternalStyle::PushVar(StyleVar varIndex, const ImVec4& value)
{
...
void InternalStyle::PopVar(int count)
{
    while (count > 0)
    {
...
const char* InternalStyle::GetColorName(StyleColor colorIndex) const
{
    switch (colorIndex)
    {
...
float* InternalStyle::GetVarFloatAddr(StyleVar idx)
{
    switch (idx)
    {
...
ImVec2* InternalStyle::GetVarVec2Addr(StyleVar idx)
{
    switch (idx)
    {
...
ImVec4* InternalStyle::GetVarVec4Addr(StyleVar idx)
{
    switch (idx)
    {
...
//
//------------------------------------------------------------------------------
ImGui::NodeEditor::Internal::Config::Config(const ImGui::NodeEditor::Config* config)
{
    if (config)
        *static_cast<ImGui::NodeEditor::Config*>(this) = *config;
}

std::string ImGui::NodeEditor::Internal::Config::Load()
{
    std::string data;
...
std::string ImGui::NodeEditor::Internal::Config::LoadNode(NodeId nodeId)
{
    std::string data;
...
void ImGui::NodeEditor::Internal::Config::BeginSave()
{
    if (BeginSaveSession)
        BeginSaveSession(UserPointer);
}

bool ImGui::NodeEditor::Internal::Config::Save(const std::string& data, SaveReasonFlags flags)
{
    if (SaveSettings)
    {
...
bool ImGui::NodeEditor::Internal::Config::SaveNode(NodeId nodeId, const std::string& data, SaveReasonFlags flags)
{
    if (SaveNodeSettings)
...
void ImGui::NodeEditor::Internal::Config::EndSave()
{
    if (EndSaveSession)
...
namespace ImGui
{
    namespace NodeEditor
    {
        static Internal::EditorContext* Editor = nullptr;
        template <typename C, typename L, typename F>
        static int BuildIdList(C& container, L* list, int listSize, F&& accept)
        {
            if (list != nullptr)
            {
                int count = 0;
                for (auto object : container)
                {
                    ...
                    if (accept(object))
                    {
                        list[count] = L(object->ID().AsPointer());
                        ++count;
                        --listSize;
                    }
                }
        ...
        {
            return reinterpret_cast<EditorContext*>(new Internal::EditorContext(config));
        }

        void DestroyEditor(EditorContext* context)
        {
            if (GetCurrentEditor() == context)
            {
                SetCurrentEditor(nullptr);
            }

            auto editor = reinterpret_cast<Internal::EditorContext*>(context);
            delete editor;
        }

        void SetCurrentEditor(EditorContext* ctx)
        {
            Editor = reinterpret_cast<Internal::EditorContext*>(ctx);
        }

        EditorContext* GetCurrentEditor()
        {
            return reinterpret_cast<EditorContext*>(Editor);
        }
        ...
        {
            return Editor->GetStyle().GetColorName(colorIndex);
        }

        void PushStyleColor(StyleColor colorIndex, const ImVec4& color)
        {
            Editor->GetStyle().PushColor(colorIndex, color);
        }

        void PopStyleColor(int count)
        {
            Editor->GetStyle().PopColor(count);
        }

        void PushStyleVar(StyleVar varIndex, float value)
        {
            Editor->GetStyle().PushVar(varIndex, value);
        }
        ...
        {
            Editor->GetNodeBuilder().Begin(id);
        }

        void BeginPin(PinId id, PinKind kind)
        {
            Editor->GetNodeBuilder().BeginPin(id, kind);
        }

        void PinRect(const ImVec2& a, const ImVec2& b)
        {
            Editor->GetNodeBuilder().PinRect(a, b);
        }

        void PinPivotRect(const ImVec2& a, const ImVec2& b)
        {
            Editor->GetNodeBuilder().PinPivotRect(a, b);
        }

        void PinPivotSize(const ImVec2& size)
        {
            Editor->GetNodeBuilder().PinPivotSize(size);
        }

        void PinPivotScale(const ImVec2& scale)
        {
            Editor->GetNodeBuilder().PinPivotScale(scale);
        }

        void PinPivotAlignment(const ImVec2& alignment)
        {
            Editor->GetNodeBuilder().PinPivotAlignment(alignment);
        }

        void EndPin()
        {
            Editor->GetNodeBuilder().EndPin();
        }

        void Group(const ImVec2& size)
        {
            Editor->GetNodeBuilder().Group(size);
        }

        void EndNode()
        {
            Editor->GetNodeBuilder().End();
        }

        bool BeginGroupHint(NodeId nodeId)
        {
            return Editor->GetHintBuilder().Begin(nodeId);
        }

        ImVec2 GetGroupMin()
        {
            return Editor->GetHintBuilder().GetGroupMin();
        }

        ImVec2 GetGroupMax()
        {
            return Editor->GetHintBuilder().GetGroupMax();
        }

        ImDrawList* GetHintForegroundDrawList()
        {
            return Editor->GetHintBuilder().GetForegroundDrawList();
        }

        ImDrawList* GetHintBackgroundDrawList()
        {
            return Editor->GetHintBuilder().GetBackgroundDrawList();
        }

        void EndGroupHint()
        {
            Editor->GetHintBuilder().End();
        }

        ImDrawList* GetNodeBackgroundDrawList(NodeId nodeId)
        {
            if (auto node = Editor->FindNode(nodeId))
                return Editor->GetNodeBuilder().GetUserBackgroundDrawList(node);
            else
                return nullptr;
        }
        ...
        {
            return Editor->DoLink(id, startPinId, endPinId, ImColor(color), thickness);
        }

        void Flow(LinkId linkId)
        {
            if (auto link = Editor->FindLink(linkId))
                Editor->Flow(link);
        }

        bool BeginCreate(const ImVec4& color, float thickness)
        {
            auto& context = Editor->GetItemCreator();
        ...
        {
            using Result = Internal::CreateItemAction::Result;
        ...
        bool QueryNewLink(PinId* startId, PinId* endId, const ImVec4& color, float thickness)
        {
            ...
            Result result = context.QueryLink(startId, endId);
        ...
        bool QueryNewNode(PinId* pinId, const ImVec4& color, float thickness)
        {
            using Result = Internal::CreateItemAction::Result;
        ...
        bool BeginDelete()
        {
            auto& context = Editor->GetItemDeleter();

            return context.Begin();
        }

        bool QueryDeletedLink(LinkId* linkId, PinId* startId, PinId* endId)
        {
            auto& context = Editor->GetItemDeleter();
        ...
        {
            Editor->SetNodePosition(nodeId, position);
        }

        ImVec2 GetNodePosition(NodeId nodeId)
        {
            return Editor->GetNodePosition(nodeId);
        }

        ImVec2 GetNodeSize(NodeId nodeId)
        {
            return Editor->GetNodeSize(nodeId);
        }
        ...
        {
            if (auto node = Editor->FindNode(nodeId))
                Editor->MarkNodeToRestoreState(node);
        }
        ...
        {
            return Editor->HasSelectionChanged();
        }

        int GetSelectedObjectCount()
        {
            return (int)Editor->GetSelectedObjects().size();
        }

        int GetSelectedNodes(NodeId* nodes, int size)
        {
            return BuildIdList(Editor->GetSelectedObjects(), nodes, size, [](auto object)
                {
        ...
        {
            return BuildIdList(Editor->GetSelectedObjects(), links, size, [](auto object)
                {
        ...
        void SelectLink(LinkId linkId, bool append)
        {
            ...
            {
                if (append)
                    Editor->SelectObject(link);
                else
                    Editor->SetSelectedObject(link);
            }
        }
        ...
        {
            if (auto node = Editor->FindNode(nodeId))
                Editor->DeselectObject(node);
        }

        void DeselectLink(LinkId linkId)
        {
            if (auto link = Editor->FindLink(linkId))
                Editor->DeselectObject(link);
        }

        bool DeleteNode(NodeId nodeId)
        {
            if (auto node = Editor->FindNode(nodeId))
                return Editor->GetItemDeleter().Add(node);
            else
                return false;
        }
        ...
        {
            if (auto link = Editor->FindLink(linkId))
                return Editor->GetItemDeleter().Add(link);
            else
                return false;
        }

        void NavigateToContent(float duration)
        {
            Editor->NavigateTo(Editor->GetContentBounds(), true, duration);
        }

        void NavigateToSelection(bool zoomIn, float duration)
        {
            Editor->NavigateTo(Editor->GetSelectionBounds(), zoomIn, duration);
        }

        bool ShowNodeContextMenu(NodeId* nodeId)
        {
            return Editor->GetContextMenu().ShowNodeContextMenu(nodeId);
        }

        bool ShowPinContextMenu(PinId* pinId)
        {
            return Editor->GetContextMenu().ShowPinContextMenu(pinId);
        }

        bool ShowLinkContextMenu(LinkId* linkId)
        {
            return Editor->GetContextMenu().ShowLinkContextMenu(linkId);
        }

        bool ShowBackgroundContextMenu()
        {
            return Editor->GetContextMenu().ShowBackgroundContextMenu();
        }

        void EnableShortcuts(bool enable)
        {
            Editor->EnableShortcuts(enable);
        }

        bool AreShortcutsEnabled()
        {
            return Editor->AreShortcutsEnabled();
        }

        bool BeginShortcut()
        {
            return Editor->GetShortcut().Begin();
        }

        bool AcceptCut()
        {
            return Editor->GetShortcut().AcceptCut();
        }

        bool AcceptCopy()
        {
            return Editor->GetShortcut().AcceptCopy();
        }

        bool AcceptPaste()
        {
            return Editor->GetShortcut().AcceptPaste();
        }

        bool AcceptDuplicate()
        {
            return Editor->GetShortcut().AcceptDuplicate();
        }

        bool AcceptCreateNode()
        {
            return Editor->GetShortcut().AcceptCreateNode();
        }

        int GetActionContextSize()
        {
            return static_cast<int>(Editor->GetShortcut().m_Context.size());
        }
        ...
        void EndShortcut()
        {
            return Editor->GetShortcut().End();
        }

        float GetCurrentZoom()
        {
            return Editor->GetView().InvScale;
        }

        NodeId GetDoubleClickedNode()
        {
            return Editor->GetDoubleClickedNode();
        }

        PinId GetDoubleClickedPin()
        {
            return Editor->GetDoubleClickedPin();
        }

        LinkId GetDoubleClickedLink()
        {
            return Editor->GetDoubleClickedLink();
        }

        bool IsBackgroundClicked()
        {
            return Editor->IsBackgroundClicked();
        }

        bool IsBackgroundDoubleClicked()
        {
            return Editor->IsBackgroundDoubleClicked();
        }

        bool PinHadAnyLinks(PinId pinId)
        {
            return Editor->PinHadAnyLinks(pinId);
        }

        ImVec2 GetScreenSize()
        {
            return Editor->GetRect().GetSize();
        }

        ImVec2 ScreenToCanvas(const ImVec2& pos)
        {
            return Editor->ToCanvas(pos);
        }

        ImVec2 CanvasToScreen(const ImVec2& pos)
        {
            return Editor->ToScreen(pos);
        }
    }
}
