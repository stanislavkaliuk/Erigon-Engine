...
namespace ImGui
{
    namespace NodeEditor
    {
        ...
        struct Object
        {
            ...
            virtual void Draw(ImDrawList* drawList, DrawFlags flags = DrawFlags::None) = 0;
        ...
        struct Pin final : Object
        {
            ...
            virtual void Draw(ImDrawList* drawList, DrawFlags flags = DrawFlags::None) override final;
        ...
        struct NavigateAction final : EditorAction
        {
            ...
            NavigateAction(EditorContext* editor, ImGui::NodeEditor::Canvas& canvas);
            ...
            ImGui::NodeEditor::CanvasView GetView() const;
        ...
        private:
            ImGui::NodeEditor::Canvas& m_Canvas;
        ...
        struct Config : ImGui::NodeEditor::Config
        {
            Config(const ImGui::NodeEditor::Config* config);
        ...
        struct EditorContext
        {
            EditorContext(const ImGui::NodeEditor::Config* config = nullptr);
            ~EditorContext();

            InternalStyle& GetStyle() { return m_Style; }
            ...
            const ImGui::NodeEditor::CanvasView& GetView() const { return m_Canvas.View(); }
