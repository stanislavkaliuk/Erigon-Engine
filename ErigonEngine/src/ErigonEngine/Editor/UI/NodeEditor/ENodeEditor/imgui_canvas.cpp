...
namespace ImGui
{
    ...
    {
        bool Canvas::Begin(const char* id, const ImVec2& size)
        {
            return Begin(GetID(id), size);
        }

        bool Canvas::Begin(ImGuiID id, const ImVec2& size)
        {
        ...
        void Canvas::End()
        {
            ...
            LeaveLocalSpace();
            SetCursorScreenPos(m_WidgetPosition);
            Dummy(m_WidgetSize);
            m_InBeginEnd = false;
        }
        ...
        void Canvas::CenterView(const ImVec2& canvasPoint)
        {
            auto view = CalculateCenterView(canvasPoint);
            SetView(view);
        }

        CanvasView Canvas::CalculateCenterView(const ImVec2& canvasPoint) const
        {
        ...
        void Canvas::CenterView(const ImRect& canvasRect)
        {
            auto view = CalculateCenterView(canvasRect);
            SetView(view);
        }

        CanvasView Canvas::CalculateCenterView(const ImRect& canvasRect) const
        {
        ...
        ImVec2 Canvas::FromLocal(const ImVec2& point, const CanvasView& view) const
        {
            return point * view.Scale + view.Origin + m_WidgetPosition;
        }

        ImVec2 Canvas::FromLocalV(const ImVec2& vector) const
        {
            return vector * m_View.Scale;
        }

        ImVec2 Canvas::FromLocalV(const ImVec2& vector, const CanvasView& view) const
        {
        ...
        ImVec2 Canvas::ToLocal(const ImVec2& point, const CanvasView& view) const
        {
            return (point - view.Origin - m_WidgetPosition) * view.InvScale;
        }

        ImVec2 Canvas::ToLocalV(const ImVec2& vector) const
        {
            return vector * m_View.InvScale;
        }

        ImVec2 Canvas::ToLocalV(const ImVec2& vector, const CanvasView& view) const
        {
