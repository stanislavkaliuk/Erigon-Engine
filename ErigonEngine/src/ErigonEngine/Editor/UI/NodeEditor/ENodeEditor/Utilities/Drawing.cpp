...
void ImGui::NodeEditor::Drawing::DrawIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, IconType type, bool filled, ImU32 color, ImU32 innerColor)
{
	auto rect = ImGui::NodeEditor::rect(to_point(a), to_point(b));
	const auto outlineScale = rect.w / 24.0f;
	const auto extraSegments = roundi(2 * outlineScale);
